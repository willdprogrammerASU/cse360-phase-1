	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				//  2: a period, underscore or minus that transitions to state 2 
				...
				// . -> State 2
				else if (currentChar == '.' || currentChar == '_' || currentChar == '-') {			// Check for a period, underscore or minus
					nextState = 2;
			...
			case 2: 
				// State 2 deals with a character after a period, underscore or minus in the name.
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, underscore or minus must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
